      ...
      <div className="grid md:grid-cols-3 grid-cols-1 gap-5">
        {customers.map((item, i) => (
          ...
          >
            ...
            <div className="inline-block bg-gray-900 text-white px-[10px] py-[6px] text-xs font-medium rounded-full min-w-[60px]">
              {item.value}
            </div>
            <div>
              <div className="flex justify-between text-sm font-normal dark:text-gray-300 mb-3 mt-4">
                <span>Progress</span>
      ...
      <div className="grid grid-cols-1 gap-5 mt-5">
        {customers2.map((item, i) => (
          ...
          >
            ...
            <div className="inline-block text-center bg-gray-900 text-white px-[10px] py-[6px] text-xs font-medium rounded-full min-w-[60px]">
              {item.value}
            </div>
            <div className="flex-1">
              <div className="flex justify-between text-sm font-normal dark:text-gray-300 mb-3">
                <span>Progress</span>
                <span className="font-normal">{item.value}%</span>
              </div>
              <ProgressBar value={item.value} className={item.barColor} />
